...
public class ServiceStateException extends RuntimeException {
  ...
  /**
   * Convert any exception into a {@link RuntimeException}. If the caught exception is already of
   * that type, it is typecast to a {@link RuntimeException} and returned.
   * <p>
   * All other exception types are wrapped in a new instance of ServiceStateException
   *
