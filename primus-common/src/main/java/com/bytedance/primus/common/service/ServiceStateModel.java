...
package com.bytedance.primus.common.service;
...
public class ServiceStateModel {
  ...
  /**
   * Create the service state model in the {@link Service.STATE#NOTINITED} state.
   */
  ...
  /**
   * Is a state transition valid? There are no checks for current==proposed as that is considered a
   * non-transition.
   * <p>
   * using an array kills off all branch misprediction costs, at the expense of cache line misses.
   *
