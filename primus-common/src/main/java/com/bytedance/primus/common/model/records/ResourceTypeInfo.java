...
import com.bytedance.primus.common.model.records.impl.pb.ResourceTypeInfoPBImpl;

/**
 * Class to encapsulate information about a ResourceType - the name of the resource, the
 * units(milli, micro, etc), the type(countable).
 */
public abstract class ResourceTypeInfo implements Comparable<ResourceTypeInfo> {
  ...
  public static ResourceTypeInfo newInstance(ResourceTypeInfo other) {
    ResourceTypeInfo resourceType = new ResourceTypeInfoPBImpl();
  ...
  /**
   * Copies the content of the source ResourceTypeInfo object to the destination object, overwriting
   * all properties of the destination object.
   *
   * @param src Source ResourceTypeInfo object
   * @param dst Destination ResourceTypeInfo object
   */
