...
public class ContainerLauncherEvent extends
    PrimusTimelineEvent<ContainerLauncherEventType> {

  private final Container container;

  public ContainerLauncherEvent(Container container, ContainerLauncherEventType type) {
    super(type);
