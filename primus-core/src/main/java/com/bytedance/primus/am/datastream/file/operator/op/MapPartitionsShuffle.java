...
public class MapPartitionsShuffle<T extends Input> implements MapPartitions<T> {
  ...
  @Override
  public Pair<String, List<T>> apply(Pair<String, List<T>> input) {
    Collections.shuffle(input.getValue());
    return input;
  }
}
