...
public class ContainerManagerEvent extends PrimusTimelineEvent<ContainerManagerEventType> {
  ...
  public ContainerManagerEvent(ContainerManagerEventType type, Container container) {
    super(type);
