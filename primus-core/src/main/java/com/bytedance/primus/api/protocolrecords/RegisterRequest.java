...
public interface RegisterRequest {
  ...
  RegisterRequest setExecutorId(ExecutorId executorId);

  ExecutorSpec getExecutorSpec();

  RegisterRequest setExecutorSpec(ExecutorSpec executorSpec);

  RegisterRequestProto getProto();
}
