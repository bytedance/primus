...
public interface HeartbeatRequest {
  ...
  void setExecutorState(ExecutorState executorState);
  boolean getNeedMoreTask();
  void setNeedMoreTask(boolean needMoreTask);
  List<TaskStatus> getTaskStatuses();
  void setTaskStatuses(List<TaskStatus> taskStatuses);
}
