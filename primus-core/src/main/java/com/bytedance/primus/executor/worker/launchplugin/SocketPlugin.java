...
public class SocketPlugin implements ChildLaunchPlugin {

  private ExecutorContext executorContext;
  private WorkerContext workerContext;

  public SocketPlugin(ExecutorContext executorContext, WorkerContext workerContext) {
  ...
  public void preStart() throws Exception {
    for (ServerSocket serverSocket : executorContext.getFrameworkSocketList()) {
