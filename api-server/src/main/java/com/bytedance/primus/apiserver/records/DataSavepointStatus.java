...
public interface DataSavepointStatus {

  DataSavepointStatus setState(DataSavepointState state);

  DataSavepointState getState();

  DataProto.DataSavepointStatus getProto();
}
